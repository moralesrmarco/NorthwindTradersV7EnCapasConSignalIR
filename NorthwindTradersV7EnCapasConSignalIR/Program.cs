...
namespace NorthwindTradersV7EnCapasConSignalIR
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                UsuarioLogueado = MostrarLogin ? usuario : new Usuario { Id = 1, Paterno = "Morales", Materno = "Rodríguez", Nombres = "Marco Antonio", User = "mmorales" }, // Simulación de usuario autenticado
